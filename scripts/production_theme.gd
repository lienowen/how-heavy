...
# Compatibility aliases used by older gameplay layers. They now map into the
# brighter casual palette so legacy code stays valid while the visual system evolves.
const BRASS := ORANGE
const BRASS_BRIGHT := Color("ffb35c")
const IVORY := WHITE
